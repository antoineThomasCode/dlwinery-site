  ...
  return (
    <section className="bg-cream py-14 sm:py-16 pb-24 md:pb-16">
      <div className="max-w-[var(--max-width)] mx-auto px-5 sm:px-6">
        <h2 className="font-heading text-2xl sm:text-3xl text-olive text-center mb-10 font-light">
          Continue Reading
        </h2>
          ...
          {posts.map((post) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-heading text-lg sm:text-xl text-olive group-hover:text-pourpre-light transition-colors mb-2 leading-snug font-medium">
                  {post.title}
                </h3>
                <p className="text-sm text-stone leading-relaxed font-body line-clamp-3 mb-4 flex-1">
                  {post.excerpt}
                </p>
                <span className="inline-flex items-center gap-1 text-pourpre-light text-xs font-body font-medium tracking-wide uppercase group-hover:gap-2 transition-all">
